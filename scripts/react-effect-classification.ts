...
export const reviewedEffectClassifications: Record<ReviewedEffectCategory, readonly string[]> = {
  "external-sync": [
    ...
    "apps/web/src/pages/SessionDetail/hooks/useSessionFiles.ts::useSessionFiles::useLayoutEffect::6d1eec2dde7d::1",
    "apps/web/src/pages/SessionDetail/hooks/useSessionFiles.ts::useSessionFiles::useLayoutEffect::8934894d30a1::1",
