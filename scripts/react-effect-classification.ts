...
export const reviewedEffectClassifications: Record<ReviewedEffectCategory, readonly string[]> = {
  "external-sync": [
    ...
    "apps/web/src/pages/SessionDetail/hooks/useSessionDiffs.ts::useSessionDiffs::useLayoutEffect::61e34e25dd2a::1",
  ...
  "identity-reset": [
    ...
    "apps/web/src/pages/SessionDetail/hooks/useSessionDiffs.ts::useSessionDiffs::useLayoutEffect::4c5ca6974476::1",
